...
const Project = () => {
  ...
  const techList=[<li>Processing</li>,<li>NRF24L01</li>,<li>HC-SR04</li>]
  ...
  const gitLink2='https://github.com/Gozi1/e-commerce-example'
  ...
  const techList3=[<li>Node.js</li>,<li>Html</li>,<li>Css</li>]
  const gitLink3 ='https://github.com/Gozi1/Website-clone'
  return (
    ...
    <div className='project' id='projects'>
      ...
      <h1 className='hoverHeader'>e</h1><h1 className='hoverHeader'>c</h1>
       <h1  className='hoverHeader '>t</h1><h1 className='hoverHeader'>s</h1>
        ...
        <h3>Here are some things I’ve worked :</h3>
        <div className='mobile-column'>
        <ProjectTemplate img ={img} text={text} title={title} techList={techList}/>
        <ProjectTemplate img ={img2} text={text2} title={title2} techList={techList2} gitLink={gitLink2}/>
        <ProjectTemplate img ={img3} text={text3} title={title3} techList={techList3} gitLink={gitLink3}/>
        </div>
    </div>
